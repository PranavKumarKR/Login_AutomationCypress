...
describe('testdesc', () => {
    it('Create User', () => {
        ...
        cy.get('input[name="name"]').type('Pranav')
        cy.get('input[name="email"]').type('Pranav@gmail.com')
        cy.get('input[type="password"]').type('pranav3')
    ...
    it('Verify Login', () => {
        ...
        cy.get('[name="email1"]').type('Pranav@gmail.com')
        cy.get('[name="password1"]').type('pranav3', {
            timeout: 1000
        })
